...
# OBS. O arquivo twitter-video-dl.py foi desenvolvido por github.com/inteoryx, direitos autorais reservados.
# OBS. The twitter-video-dl.py was developed by github.com/inteoryx, copyright reserved
